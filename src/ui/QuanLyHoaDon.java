...
public class QuanLyHoaDon extends JFrame implements MouseListener {
	 ...
	 */
	public QuanLyHoaDon() throws RemoteException {
		...
		pnlThongTinHD.setBorder(new TitledBorder(
				...
				"Th\u00F4ng tin h\u00F3a \u0111\u01A1n", TitledBorder.LEFT, TitledBorder.TOP, null,
		...
		pnlHoaDon.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
		...
		tableHoaDon.setModel(model = new DefaultTableModel(new Object[][] {},
				new String[] { "M\u00E3 h\u00F3a \u0111\u01A1n", "Ng\u00E0y l\u1EADp", "T\u00EAn kh\u00E1ch h\u00E0ng",
		...
		btnXemHD.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ui.ChiTietHoaDon ct = null;
				try {
					ct = new ui.ChiTietHoaDon();
...
//            setVisible(false);
		...
		btnThoat.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int select = JOptionPane.showConfirmDialog(null, "Bạn có chắc chắn muốn thoát?", "Cảnh Báo",
...
//	});
	...
	public void DocDuLieuTuSQLVaoTable() throws RemoteException {
